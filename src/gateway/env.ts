...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  const isWorkersAI = normalizedBaseUrl?.endsWith('/workers-ai');
  ...
  if (env.AI_GATEWAY_API_KEY) {
    ...
    // Workers AI doesn't need an API key - use a placeholder
    envVars.OPENAI_API_KEY = 'workers-ai';
  }
  ...
  if (env.MOLTBOT_MODEL) envVars.MOLTBOT_MODEL = env.MOLTBOT_MODEL;
